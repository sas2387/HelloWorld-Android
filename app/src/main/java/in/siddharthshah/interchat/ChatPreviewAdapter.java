...
public class ChatPreviewAdapter extends ArrayAdapter<String>{

    public ChatPreviewAdapter(Context context, ArrayList<String> chatPreviews) {
        super(context, 0, chatPreviews);
    }
